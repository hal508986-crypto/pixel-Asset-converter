...
- Import roots observed: `PIL, PySide6, __future__, argparse, ast, collections, colorsys, copy, csv, cv2, dataclasses, datetime, enum, fnmatch, hashlib, importlib, itertools, json, logging, math, numpy, os, pathlib, pixel_tile_compiler, pydantic, pytest, random, re, scripts, shutil, skimage, string, subprocess, sys, tempfile, threading, time, tomllib, tracemalloc, typer, types, typing, uuid, yaml`
